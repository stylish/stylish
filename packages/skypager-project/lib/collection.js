...
var Collection = (function () {
  ...
  */
  ...
  function Collection() {
    ...
    invariant(root && root.length > 0, 'Must pass a root property representing this collections path');

    invariant(assetClass && assetClass.GLOB && assetClass.EXTENSIONS, 'Must create a collection by passing a valid Skypager.Asset subclass.');
  ...
  (0, _createClass3.default)(Collection, [{
    ...
    */
    ...
    value: function loadAssetsFromDisk() {
      ...
      this.AssetClass._collectionDidLoadAssets.call(this, this, { paths: paths });
...
function buildAtInterface(collection) {
  ...
  if (expand) {
    ...
    expanded.forEach(function (id) {
      ...
      (0, _set2.default)(collection.at, dp, collection.at(id));
    });
  }
}
  ...
  defineProperty(array, 'condense', {
    ...
    value: function condense() {
      ...
      return array.reduce(function (memo, a) {
        ...
        if (key === 'idpath') {
          (0, _set2.default)(memo, a.id.replace(/\//g, '.'), asset);
          return memo;
        }
