...
exports.LockedApplication = undefined;
...
var LockedApplication = exports.LockedApplication = (function (_Application) {
  (0, _inherits3.default)(LockedApplication, _Application);

  function LockedApplication() {
    (0, _classCallCheck3.default)(this, LockedApplication);
    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(LockedApplication).apply(this, arguments));
  }

  (0, _createClass3.default)(LockedApplication, null, [{
    key: 'create',
    value: function create() {
      var options = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];

      options.defer = true;
      var render = _Application3.default.create(options);
...
exports.default = LockedApplication;