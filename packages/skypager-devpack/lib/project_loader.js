...
module.exports = (function () {
  (0, _createClass3.default)(ProjectLoader, null, [{
    key: 'create',
    value: function create() {
      ...
      return new (Function.prototype.bind.apply(ProjectLoader, [null].concat(args)))();
    }
  }]);

  function ProjectLoader(bundle) {
    var options = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];
    (0, _classCallCheck3.default)(this, ProjectLoader);
  ...
  (0, _createClass3.default)(ProjectLoader, [{
    key: 'createApp',
