...
function availableThemes(project) {
  return {
    ...
    'dashboard-dark': 'twitter bootstrap pro dashboard theme, dark variant. (license required)',
    'marketing': 'twitter boostrap pro marketing site theme. (license required)',
