...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  (0, _createClass3.default)(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'box',
	        (0, _extends3.default)({ label: 'skypager' }, borderStyles({ color: 'magenta', type: 'line' }), {
	          __source: {
	...
	function borderStyles() {
	  var options = arguments.length <= 0 || arguments[0] === undefined ? { style: style, color: color } : arguments[0];
...
//# sourceMappingURL=0.963742e972e157f0c716.hot-update.js.map