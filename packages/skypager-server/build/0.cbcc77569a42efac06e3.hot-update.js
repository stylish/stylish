	  ...
	  (0, _createClass3.default)(App, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'box',
	        (0, _extends3.default)({ label: 'skypager' }, borderStyles('magenta'), {
	          __source: {
	        ...
	        _react2.default.createElement('bigtext', (0, _extends3.default)({ label: 'console', top: '80%', height: '16%', left: '42%', width: '57%' }, borderStyles('yellow'), {
	          __source: {
	            fileName: _jsxFileName,
	            lineNumber: 41
	          }
...
//# sourceMappingURL=0.cbcc77569a42efac06e3.hot-update.js.map